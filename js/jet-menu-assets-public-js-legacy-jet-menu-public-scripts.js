		...
		maybeTemplateLoad: function (templateId, $templateContainer) {
			...
			$.ajax({
				...
				success: function (responce, textStatus, jqXHR) {
					...
					jetMenu.supereventContentRender($templateContainer, templateContent);
				}
			});
		},
...
(function ($) {
	...
	window.jetMenu = {
			...
			Vue.component('mobile-menu-item', {
				...
				computed: {
					...
					isTemplateDefine: function () {
						return false !== this.itemDataObject.supereventTemplateId ? true : false;
					},
				...
				methods: {
					...
					switchToSub: function (event) {
						...
						if (!this.isTemplateDefine) {
							...
							if (!this.itemDataObject.supereventContent) {
								this.getsupereventTemplate();
							} else {
								...
								jetMenu.eventBus.$emit('showTemplateContent', {
									...
									id: this.itemDataObject.id,
									name: this.itemDataObject.name,
									supereventContent: this.itemDataObject.supereventContent
								});
							}
						}
					},

					getsupereventTemplate: function () {
						...
						vueInstance.ajaxRequest = $.ajax({
							...
							dataType: 'json',
							data: {
								'id': vueInstance.itemDataObject.supereventTemplateId,
								'dev': window.jetMenuPublicSettings.devMode
							},
							beforeSend: function (jqXHR, ajaxSettings) {
							...
							success: function (responce, textStatus, jqXHR) {
								...
								vueInstance.itemDataObject.supereventContent = templateContent;

								jetMenu.eventBus.$emit('showTemplateContent', {
									menuUniqId: vueInstance.$root.menuOptions.menuUniqId,
									id: vueInstance.itemDataObject.id,
									name: vueInstance.itemDataObject.name,
									supereventContent: vueInstance.itemDataObject.supereventContent
								});
							}
						});
					}
			...
			Vue.component('mobile-menu', {
				...
				mounted: function () {
					...
					jetMenu.eventBus.$on('showTemplateContent', function (payLoad) {
						...
						vueInstance.itemTemplateContent = payLoad.supereventContent;
				...
				methods: {
					...
					showTemplateContent: function () {
						...
						this.$nextTick(function () {
							...
							jetMenu.supereventContentRender($templateContainer);
						});
					},
					...
					initTemplatesContent: function () {
						...
						this.$nextTick(function () {
							...
							if (vueInstance.headerContent) {
								...
								jetMenu.supereventContentRender($headerContainer);
							}

							if (vueInstance.beforeContent) {
								let $beforeContainer = $(vueInstance.$refs['before-template-content']);

								jetMenu.supereventContentRender($beforeContainer);
							}

							if (vueInstance.afterContent) {
								let $afterContainer = $(vueInstance.$refs['after-template-content']);

								jetMenu.supereventContentRender($afterContainer);
							}
						});
					},
		...
		supereventContentRender: function ($templateContainer, templateContent) {
			...
			Promise.all(jetMenu.addedAssetsPromises).then(function (value) {
				...
				jetMenu.supereventFrontendInit($templateContainer);
		...
		supereventFrontendInit: function ($templateContainer) {
			...
			$templateContainer.find('div[data-element_type]').each(function () {
				...
				try {
					if ('widget' === elementType) {
						...
						if (window.supereventFrontend && window.supereventFrontend.hooks) {
