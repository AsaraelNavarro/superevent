(function ($, superevent) {
	...
	var JetMenuWidget = {
		...
		init: function () {
			...
			$.each(widgets, function (widget, callback) {
				superevent.hooks.addAction('frontend/element_ready/' + widget, callback);
			});
		...
		widgetCustomMenu: function ($scope) {
			...
			function setSubMenuPosition() {
				...
				var subMenu = $('.jet-custom-nav__sub', $target),
					...
					isMobile = 'mobile' === superevent.getCurrentDeviceMode();
	...
	$(window).on('superevent/frontend/init', JetMenuWidget.init);

}(jQuery, window.supereventFrontend));
